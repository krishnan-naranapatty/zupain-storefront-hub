      ...
      <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex flex-col space-y-1">
              ...
              <Select value={category} onValueChange={setCategory}>
                <SelectTrigger className="w-52 h-11 bg-gray-50 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
        ...
        {hasActiveFilters && (
          <Button 
            ...
            className="text-red-600 border-red-200 hover:bg-red-50 hover:border-red-300 rounded-xl px-6 h-11 font-medium transition-all duration-200 flex items-center space-x-2"
          >
            <X className="w-4 h-4" />
